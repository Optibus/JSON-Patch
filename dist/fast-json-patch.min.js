 ...
 * MIT license
 */
var o=r(0),a=r(4),i=r(1),p=new WeakMap,u=function(e){this.observers=new Map,this.obj=e},s=function(e,t){this.callback=e,this.observer=t};function c(e,t){void 0===t&&(t=!1);var r=p.get(e.object);h(r.value,e.object,e.patches,"",t),e.patches.length&&i.applyPatch(r.value,e.patches);var n=e.patches;return n.length>0&&(e.patches=[],e.callback&&e.callback(n)),n}function f(e,t,r,o){var p=a.default(e,t);if(p.length===e.length)return[];var u=[];p.forEach(function(t){var r=e.indexOf(t);u.push({op:"remove",path:"/"+r}),o&&u.push({op:"test",path:"/"+r,value:t})});var s=(p=a.default(t,e)).map(function(e){return{op:"add",value:e,path:"/"+t.indexOf(e)}}),c=u.reverse().concat(s);return function(e,t,r){var n=e.map(function(e){return e});if(i.applyPatch(n,r),n.length!==t.length)return!1;for(var o=0;o<t.length;o++)if(n[o]!==t[o])return!1;return!0}(e,t,c)?c.map(function(e){return n({},e,{path:r+e.path})}):[]}function h(e,t,r,n,a){if(t!==e){"function"==typeof t.toJSON&&(t=t.toJSON());var i=o._objectKeys(t),p=o._objectKeys(e),u=!1;if(Array.isArray(e)&&Array.isArray(t)){var s=f(e,t,n,a);if(s.length)return s.forEach(function(e){return r.push(e)})}for(var c=p.length-1;c>=0;c--){var l=e[v=p[c]];if(!o.hasOwnProperty(t,v)||void 0===t[v]&&void 0!==l&&!1===Array.isArray(t))Array.isArray(e)===Array.isArray(t)?(a&&r.push({op:"test",path:n+"/"+o.escapePathComponent(v),value:o._deepClone(l)}),r.push({op:"remove",path:n+"/"+o.escapePathComponent(v)}),u=!0):(a&&r.push({op:"test",path:n,value:e}),r.push({op:"replace",path:n,value:t}),!0);else{var d=t[v];"object"==typeof l&&null!=l&&"object"==typeof d&&null!=d&&Array.isArray(l)===Array.isArray(d)?h(l,d,r,n+"/"+o.escapePathComponent(v),a):l!==d&&(!0,a&&r.push({op:"test",path:n+"/"+o.escapePathComponent(v),value:o._deepClone(l)}),r.push({op:"replace",path:n+"/"+o.escapePathComponent(v),value:o._deepClone(d)}))}}if(u||i.length!=p.length)for(c=0;c<i.length;c++){var v=i[c];o.hasOwnProperty(e,v)||void 0===t[v]||r.push({op:"add",path:n+"/"+o.escapePathComponent(v),value:o._deepClone(t[v])})}}}t.unobserve=function(e,t){t.unobserve()},t.observe=function(e,t){var r,n=function(e){return p.get(e)}(e);if(n){var a=function(e,t){return e.observers.get(t)}(n,t);r=a&&a.observer}else n=new u(e),p.set(e,n);if(r)return r;if(r={},n.value=o._deepClone(e),t){r.callback=t,r.next=null;var i=function(){c(r)},f=function(){clearTimeout(r.next),r.next=setTimeout(i)};"undefined"!=typeof window&&(window.addEventListener("mouseup",f),window.addEventListener("keyup",f),window.addEventListener("mousedown",f),window.addEventListener("keydown",f),window.addEventListener("change",f))}return r.patches=[],r.object=e,r.unobserve=function(){c(r),clearTimeout(r.next),function(e,t){e.observers.delete(t.callback)}(n,r),"undefined"!=typeof window&&(window.removeEventListener("mouseup",f),window.removeEventListener("keyup",f),window.removeEventListener("mousedown",f),window.removeEventListener("keydown",f),window.removeEventListener("change",f))},n.observers.set(t,new s(t,r)),r},t.generate=c,t.compare=function(e,t,r){void 0===r&&(r=!1);var n=[];return h(e,t,n,"",r),n}},function(e,t){function r(e){return e!=e}function n(e,t){return!!(null==e?0:e.length)&&function(e,t,n){return t==t?function(e,t,r){for(var n=r-1,o=e.length;++n<o;)if(e[n]===t)return n;return-1}(e,t,n):function(e,t,r,n){for(var o=e.length,a=r+(n?1:-1);n?a--:++a<o;)if(t(e[a],a,e))return a;return-1}(e,r,n,!1)}(e,t,0)>-1}Object.defineProperty(t,"__esModule",{value:!0});t.default=function(e,t){var r=n,o=[],a=t.length;if(!e.length)return o;e:for(var i=0,p=e;i<p.length;i++){var u=p[i],s=u;if(u=0!==u?u:0,s==s){for(var c=a;c--;)if(t[c]===s)continue e;o.push(u)}else r(t,s)||o.push(u)}return o}}]);